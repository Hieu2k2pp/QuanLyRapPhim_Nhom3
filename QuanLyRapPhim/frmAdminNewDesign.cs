...
using QuanLyRapPhim.frmAdminUserControls;
using System;
...
namespace QuanLyRapPhim
{
    public partial class frmAdminNewDesign : Form
    {
        ...
        private void btnRevenueUC_CheckedChanged(object sender, EventArgs e)
        {
        }

        private void btnDataUC_CheckedChanged(object sender, EventArgs e)
        {
        }

        private void btnStaffUC_CheckedChanged(object sender, EventArgs e)
        {
        }

        private void btnCustomerUC_CheckedChanged(object sender, EventArgs e)
        {
        }

        private void btnAccountUC_CheckedChanged(object sender, EventArgs e)
        {
        }
